...
public class EngineMetaComponentCreator
{
  ...
  protected OperatorFactory getOperatorFactory() {
    return _graph.getOperatorFactory();
  }
  ...
  protected void attachMetaComponents()
  {
    ...
    OperatorCore metaTargetOp =
            getOperatorFactory().createSystemOperatorCore(UserGraphExitOperator.class,
                                                               "UserGraphExit");
    ...
    OperatorCore metaSourceOp =
            getOperatorFactory().createSystemOperatorCore(UserGraphEntranceOperator.class,
                                                               "UserGraphEntrance");
                                                                                      ...
                                                                                      MetaSection metaSourceSection)
  {
    ...
    OperatorCore processControlOp =
            getOperatorFactory().createSystemOperatorCore(ProcessControlOperator.class,
                                                               "ProcessController");
