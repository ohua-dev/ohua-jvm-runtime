...
// TODO fix these test cases by fixing JavaBackendProvider
public class testCycles extends AbstractFlowTestCase
{
    ...
    public void testSimpleCycle() throws Throwable {
        registerFunction("func-prod", testFunctionalOperator.FunctionalProducer.class.getDeclaredMethod("produce"));
        registerFunction("inc", IncOperator.class.getDeclaredMethod("inc", int.class, String.class));
...
//    GraphVisualizer.PRINT_FLOW_GRAPH = getTestMethodOutputDirectory() + "flow-graph";
    ...
    public void testImplicitFeedback() throws Throwable {
        registerFunction("func-prod", testFunctionalOperator.FunctionalGenericProducer.class.getDeclaredMethod("produce", Object[].class));
        registerFunction("inc", RawIncOperator.class.getDeclaredMethod("inc", int.class));
        Map ops = null;
